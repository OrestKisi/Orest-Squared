...
public class WeatherStation extends Observable implements Runnable {
    ...
    private final Barometer pressure;   // Pressure sensor.

    private final long PERIOD = 1000 ;      // 1 sec = 1000 ms
    private final int KTOC = -27315 ;       // Kelvin to Celsius conversion
    private final double ITOM = 33.8637526; //Inches to millibars conversion
    private final SwingUI sui;
    private final AWTUI aui;
    ...
    public WeatherStation() {
        ...
        sui = new SwingUI(this) ;
        aui = new AWTUI(this);
        pressure = new Barometer() ;
    ...
    public synchronized double getFahrenheit() {
        return (getKelvin() - 273.15) * 1.8 + 32;
    }
